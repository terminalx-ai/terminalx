...
function PairingSheet({ visible, error, onClearError, onClose, onPair }: { visible: boolean; error: string | null; onClearError(): void; onClose(): void; onPair(code: string): Promise<void> }) {
  const { palette } = useTheme();
