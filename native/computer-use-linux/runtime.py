#!/usr/bin/env python3
"""TerminalX Linux computer-use bridge.

The Node sidecar owns TerminalX's public API. This process is intentionally a small
...
def handshake_response():
    ...
    return {
        "platform": "linux",
        "provider": "terminalx-computer-use-linux",
