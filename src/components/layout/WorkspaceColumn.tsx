  ...
  return (
    <div className="mb-1.5">
      <div className="group/ws relative flex h-7 items-center gap-1.5 rounded-md px-1.5 text-[11px] text-muted-foreground hover:bg-selected/40" title={path}>
        ...
        {ws && (
          <span className="flex shrink-0 items-center gap-1 tabular-nums group-hover/ws:hidden">
        ...
        {ws && (
          <span className="absolute right-1 hidden items-center group-hover/ws:flex">
