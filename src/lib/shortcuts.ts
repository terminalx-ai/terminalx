...
export const SHORTCUTS: Shortcut[] = [
  ...
  { chord: "mod+shift+u", label: "Stats & Usage", group: "App" },
  ...
  { chord: "mod+t", label: "New tab", group: "Session" },
  ...
  { chord: "mod+j", label: "Activate latest shell tab", group: "Session" },
  ...
  { chord: "mod+shift+h", label: "Replace in project", group: "Files" },
  { chord: "mod+f", label: "Find in the open file", group: "Files" },
